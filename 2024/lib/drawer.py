...
#DIMENSIONE SINGOLI TILE
tile_pixel = int(sys.argv[1])
...
num_cols, num_rows, num_golden_points, num_silver_points, num_tile_types, golden_points, silver_points, tiles = ip.parse_input_file(input_file_path)

#PARSING DEL FILE DI OUTPUT
output_file_path = './2024/output/00-trailer_Solution1.txt'
tile_data = op.parse_output_file(output_file_path)
